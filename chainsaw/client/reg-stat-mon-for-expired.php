      ...
      <div class="content border border-primary">
        <div class="content-container">
          <div class="content-header">
            <h4>Chainsaw > <span class="fs-5">Registration Status Monitoring > Expired</span></h4>
          </div>
          <nav class="status-list-nav">
            <ul>
              ...
              <li style="background-color: #3C9811; color: #FFFFFF;" onclick="location.href='reg-stat-mon-for-expired.php'">Expired</li>
            </ul>
          </nav>
          <div class="table-responsive">
            ...
            <tr>
              ...
              <th>Released By:</th>
              <th>Validity Date</th>
              <th>Copy of Chainsaw Registration Certification</th>
              <th>Action</th>
            </tr>
          </thead>
          <tbody>
          <?php
                ...
                $select = "SELECT * FROM registrations WHERE client_id = " . $_SESSION['client_id'] . " AND status = 'for-expired' ORDER BY date_and_time_submitted DESC";
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  <tr>
                    ...
                    <td>
                      <a class='btn btn-primary btn-sm' href='application-for-renewal.php?id=$row[registration_id]&status=expired'>Apply for Renewal</a>
                    </td>
                  </tr>
                ";
                }
