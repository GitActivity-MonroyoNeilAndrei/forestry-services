...
<body>
  <div class="body">
    ...
    <div class="page-content">
      ...
      <div class="content border border-primary mx-auto">
        <div class="content-container">
          ...
          <form class="row" method="post" enctype="multipart/form-data">
            ...
            <div class="border-end border-primary d-flex flex-column px-4 py-2 col-sm-5">
              ...
              <input class="form-control mb-4" type="text" name="purpose" value="<?php echo $purpose; ?>" required>
              <h5 class="text-center">Upload New Documents</h5>
            ...
            <div class="p-3 col-sm-7">
              <h6 class="text-center border-bottom border-dark pb-2" style="--bs-border-opacity: .5;">Chainsaw Complete Details</h5>
                ...
                <div class="text-center mt-4">
                  ...
                  <a class="btn btn-danger" href="reg-stat-mon-for-expired.php">Cancel</a>
                </div>
            </div>
          </form>
        </div>
