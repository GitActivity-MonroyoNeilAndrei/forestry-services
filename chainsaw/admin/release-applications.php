      ...
      <div class="nav-links">
        <nav style="position: sticky; top: 6vh;">
          <ul>
            ...
            <li class="bg-dark-gray2" onclick="location.href='release-applications.php'">Released Applications</li>
      ...
      <div class="content border border-primary">
        <div class="content-container">
          <div class="content-header">
            <h4>Chainsaw > <span class="fs-5">Released Applications</span></h4>
          </div>
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
                ...
                $select = "SELECT * FROM registrations WHERE status = 'for-released' ORDER BY date_and_time_submitted DESC";
