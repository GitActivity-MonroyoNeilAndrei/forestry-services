  ...
  <div class="page-content">
    ...
    <div class="content border border-primary">
      <div class="content-container">
        ...
        <h4>COV > <span class="fs-5">List of Signatories</span></h4>
        </div>
        ...
        <nav class="status-list-nav">
            <ul>
              ...
              <li style="background-color: #3C9811; color: #FFFFFF;"  onclick="location.href='crude-signatories.php'">Signatories</li>
            </ul>
          </nav>
        ...
        <a class="btn btn-success bg-green-3" href="add-new-signatories.php">Add New Signatories</a>
        <div class="table-responsive">
          ...
          $select = "SELECT * FROM signatories ORDER BY signatories_id DESC";
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            <td>
              ...
              <a class='btn btn-danger btn-sm mb-1' href='deactivate-signatories.php?id=$row[signatories_id]&status=deactivated'>Deactivate</a>
              <a class='btn btn-success btn-sm' href='deactivate-signatories.php?id=$row[signatories_id]&status=activated'>Activate</a>
