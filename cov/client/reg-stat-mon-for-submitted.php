      ...
      <div class="content border border-primary">
        <div class="content-container">
          <div class="content-header">
            <h4>COV > <span class="fs-5">Registration Status Monitoring > Submitted</span></h4>
          </div>
          <nav class="status-list-nav">
            <ul>
              <li onclick="location.href='reg-stat-mon-for-draft.php'">Draft</li>
              <li style="background-color: #3C9811; color: #FFFFFF;" onclick="location.href='reg-stat-mon-for-submitted.php'">Submitted</li>
            ...
            <table class="table table-striped table-hover">
              <thead>
                ...
                <tr>
                  ...
                  <th>Date and Time Submitted (yyyy-mm-dd)</th>
              ...
              $select = "SELECT * FROM cov_registrations WHERE cov_client_id = ".$_SESSION['cov_client_id']." AND status = 'for-submitted' ORDER BY date_and_time_submitted DESC";
              ...
              while($row = $result->fetch_assoc()){
                echo "
                  <tr>
                    ...
                    <td>
                      <a class='btn btn-primary btn-sm' href='view-submitted-application.php?id=$row[cov_registration_id]&status=submitted'>View</a>
                    </td>
                  </tr>
                ";
              }
