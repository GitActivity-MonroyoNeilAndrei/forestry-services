...
<head>
  ...
  <title>Application for Accepted</title>
      ...
      <div class="content border border-primary">
        <div class="content-container">
          <div class="content-header">
            <h4>COV > <span class="fs-5">Registration Status Monitoring > Accepted</span></h4>
          </div>
          <nav class="status-list-nav">
            <ul>
              ...
              <li style="background-color: #3C9811; color: #FFFFFF;" onclick="location.href='reg-stat-mon-for-accepted.php'">Accepted</li>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
                ...
                $select = "SELECT * FROM cov_registrations WHERE cov_client_id = " . $_SESSION['cov_client_id'] . " AND status = 'accepted' ORDER BY date_and_time_submitted DESC";
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  <tr>
                    ...
                    <td class='text-center'>
                      <a class='btn btn-primary btn-sm' href='view-submitted-application.php?id=$row[cov_registration_id]&status=accepted'>View</a>
                    </td>
                  </tr>
                ";
                }
