  ...
  if(mysqli_num_rows($check) > 0){
    ...
    if($error1 === 0 && $error2 === 0) {
        ...
        if (in_array($img_ex_lc1, $allowed_exs) && in_array($img_ex_lc2, $allowed_exs))  {
          ...
          $insert = "INSERT INTO ptpr_registrations (registration_number, name, address, purpose, tax_declaration, special_power_of_attorney, tax_declaration_number, barangay, municipality, province, total_lot_area, area_devoted_to_plantation, species, number_of_trees, date_and_time_submitted, uploaded_requirements, status) " . "VALUES ('$date_now', '$name', '$address', '$purpose', '$new_img_name1', '$new_img_name2', '$tax_declaration_number', '$barangay', '$municipality', '$province', '$total_lot_area', '$area_devoted_to_plantation', '$species', '$number_of_trees', '$date_and_time_submitted', '$uploaded_requirements', '$status')";
