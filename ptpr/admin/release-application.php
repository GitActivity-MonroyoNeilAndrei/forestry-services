  ...
  if (isset($_POST['submit'])) {
    ...
    if ($error1 === 0) {
      ...
      if (in_array($pdf_ex_lc1, $allowed_exs)) {
        ...
        $update = "UPDATE ptpr_registrations SET documents = '$new_pdf_name1', permit_number = '$permit_number', date_and_time_released = '$date_and_time_released', released_by = '$released_by', validity_date = '$validity_date', status = '$status' WHERE ptpr_registration_id = $_GET[id]";
