      ...
      <div class="content border border-primary">
        <div class="content-container">
          <div class="content-header">
            <h4>PTPR > <span class="fs-5">Registration Status Monitoring > Released</span></h4>
          </div>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              <tbody>
                ...
                $select = "SELECT * FROM ptpr_registrations WHERE ptpr_client_id = " . $_SESSION['client_id'] . " AND status = 'for-released' ORDER BY date_and_time_submitted DESC";
