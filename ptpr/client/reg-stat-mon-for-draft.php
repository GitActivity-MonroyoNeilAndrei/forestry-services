    ...
    <div class="page-content">
      ...
      <div class="content border border-primary">
        <div class="content-container">
          ...
          <h4>PTPR > <span class="fs-5">Registration Status Monitoring > Draft</span></h4>
          </div>
          ...
          <div class="table-responsive">
            <table class="table table-striped table-hover">
              ...
              $select = "SELECT * FROM ptpr_registrations WHERE ptpr_client_id = ".$_SESSION['client_id']." AND status = 'for-draft' ORDER BY date_and_time_submitted DESC";
              ...
              while($row = $result->fetch_assoc()){
                ...
                <tr>
                  ...
                  <td>
                    <a class='btn btn-primary btn-sm' href='application-edit.php?id=$row[ptpr_registration_id]&status=draft'>Edit</a>
                  </td>
