      ...
      <div class="content border border-primary">
        <div class="content-container">
          <div class="content-header">
            <h4>PTPR > <span class="fs-5">Registration Status Monitoring > Accepted</span></h4>
          </div>
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  <tr>
                    ...
                    <td class='text-center'>
                      <a class='btn btn-primary btn-sm' href='view-submitted-application.php?id=$row[ptpr_registration_id]&status=accepted'>View</a>
                    </td>
                  </tr>
                ";
                }
