      ...
      <div class="content border border-primary">
        <div class="content-container">
          <div class="content-header">
            <h4>PTPR > <span class="fs-5">Registration Status Monitoring > Expired</span></h4>
          </div>
          ...
          <div class="table-responsive">
            ...
            <tr>
              ...
              <th>Released By:</th>
              <th>Validity Date</th>
              <th>Copy of PTPR with text watermark in the body of the permit EXPIRED</th>
              <th>Action</th>
            </tr>
          </thead>
          <tbody>
          <?php
                ...
                $select = "SELECT * FROM ptpr_registrations WHERE ptpr_client_id = " . $_SESSION['client_id'] . " AND status = 'for-expired' ORDER BY date_and_time_submitted DESC";
